  ...
  return (
    <section id="timeline" className="relative py-24 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        {/* Section Header */}
        <motion.div className="space-y-3 mb-20 text-center md:text-left" {...fadeUpVariant}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3 pb-2 border-b border-slate-900/40">
            ...
            <div className="space-y-6 relative border-l border-slate-900/80 ml-4 pl-6">
...
function TimelineCard({ item, type }) {
  ...
  return (
    ...
    >
      ...
      {/* Timeline Node Ring Anchor (Reacts to Hover) */}
      <div className={`absolute -left-[31px] top-7 w-2.5 h-2.5 rounded-full bg-slate-950 border-2 ${isHovered ? (isExp ? 'border-cyan-500' : 'border-purple-500') : 'border-slate-800'} transition-colors duration-300 z-10`} />
